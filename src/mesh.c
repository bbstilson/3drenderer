...
face_t cube_faces[N_CUBE_FACES] = {
    ...
    // right
    {.a = 4, .b = 3, .c = 5, .color = ORANGE},
    {.a = 4, .b = 5, .c = 6, .color = ORANGE},
    // back
    {.a = 6, .b = 5, .c = 7, .color = YELLOW},
    {.a = 6, .b = 7, .c = 8, .color = YELLOW},
    // left
    {.a = 8, .b = 7, .c = 2, .color = GREEN},
    {.a = 8, .b = 2, .c = 1, .color = GREEN},
    // top
    {.a = 2, .b = 7, .c = 5, .color = BLUE},
    {.a = 2, .b = 5, .c = 3, .color = BLUE},
    // bottom
    {.a = 6, .b = 8, .c = 1, .color = PURPLE},
    {.a = 6, .b = 1, .c = 4, .color = PURPLE}};
